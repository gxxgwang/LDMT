...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", default="config/nemo-256.yaml", help="path to config")
    parser.add_argument("--mode", default="reconstruction", choices=["train", "reconstruction"])
